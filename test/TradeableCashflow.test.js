...
contract("TradeableCashflow", (accounts) => {
    ...
    describe("sending flows", async function () {
        ...
        // Bob is the INFLUENCER
        // Alice, Carol are the SUBSCRIBERS
        // Admin is the COMPANY being subscribed to by Alice, Carol

        // it("Case #1 - Alice subscribes and unsubscribes through Bobs referral code", async () => {
        //     const { alice } = u;
        //     await upgrade([alice]);
        ...
        //     await appStatus();
        //     await logUsers();
        //     await app.makeAffiliateLink(u.bob.address, "1", 4000);
        ...
        //
        //     assert.equal(
        //       await app.balanceOf(u.bob.address),
        //       1,
        //       "Bob doesn't have the NFT"
        //     );
        //
        //     assert.equal(
        ...
        //         "app balances aren't correct"
        //     );
        //
        //     // Numbers off a bit, take it to 6 significant figures
        //     assert.equal(
        //         bobFinalBalance.toString().substring(0,6),
        //         ((aliceInitialBalance - aliceFinalBalance) * 0.2).toString().substring(0,6),
        //         "bob balances aren't correct"
        //     );
        //
        //     assert.equal(
        //         adminFinalBalance.toString().substring(0,6),
        //         ((aliceInitialBalance - aliceFinalBalance) * 0.8).toString().substring(0,6),
        //
        ...
        // it("Case #2 - Alice and Carol subscribe and only Alice unsubscribes through Bobs referral code", async () => {
        //     const { alice, carol, bob } = u;
        //     await upgrade([alice]);
        //     await upgrade([carol]);
        //     await checkBalances([alice, carol, bob, u.admin]);
        //     await daix.transfer(app.address, toWad(0.4000), {from: u.alice.address});
        //     const appInitialBalance = await daix.balanceOf(app.address);
        //     const aliceInitialBalance = await daix.balanceOf(u.alice.address);
        //     const carolInitialBalance = await daix.balanceOf(u.carol.address);
        //     const bobInitialBalance = await daix.balanceOf(u.bob.address);
        //     const adminInitialBalance = await daix.balanceOf(u.admin.address);
        //     await appStatus();
        //     await logUsers();
        ...
        //     await alice.flow({ flowRate: toWad(0.00004000), recipient: u.app });
        //     await carol.flow({ flowRate: toWad(0.00004000), recipient: u.app });
        //     console.log("go forward in time");
        //     await traveler.advanceTimeAndBlock(TEST_TRAVEL_TIME);
        //     await appStatus();
        //     await logUsers();
        ...
        //     const appFinalBalance = await daix.balanceOf(app.address);
        //     const aliceFinalBalance = await daix.balanceOf(u.alice.address);
        //     const carolFinalBalance = await daix.balanceOf(u.carol.address);
        //     const bobFinalBalance = await daix.balanceOf(u.bob.address);
        //     const adminFinalBalance = await daix.balanceOf(u.admin.address);
        //
        //     assert.equal(
        ...
        //
        //
        //     // NOTE: I can't seem to get these to line up, but they're close enough
        //     // assert.equal(
        //     //     appInitialBalance.toString(),
        //     //     appFinalBalance.toString(),
        //     //     "app balances aren't correct"
        ...
        //     // assert.equal(
        //     //     bobFinalBalance.toString().substring(0,6),
        //     //     ((aliceInitialBalance - aliceFinalBalance) * 0.25 + (carolInitialBalance - carolFinalBalance) * 0.25).toString().substring(0,6),
        //     //     "bob balances aren't correct"
        //     // );
        //
        //     // assert.equal(
        //     //     adminFinalBalance.toString().substring(0,6),
        //     //     ((aliceInitialBalance - aliceFinalBalance) * 0.75 + (carolInitialBalance - carolFinalBalance) * 0.75).toString().substring(0,6),
        //     //
        //     //     "admin balances aren't correct"
        //     // );
        //
